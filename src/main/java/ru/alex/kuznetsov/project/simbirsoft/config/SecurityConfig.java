...
import ru.alex.kuznetsov.project.simbirsoft.config.jwt.JwtFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/projectStatus/*").hasRole("ADMIN")
                .antMatchers("/release/*").hasRole("ADMIN")
                .antMatchers("/task/*").hasRole("ADMIN")
                .antMatchers("/taskStatus/*").hasRole("ADMIN")
                .antMatchers("/userByProject/*").hasRole("ADMIN")
